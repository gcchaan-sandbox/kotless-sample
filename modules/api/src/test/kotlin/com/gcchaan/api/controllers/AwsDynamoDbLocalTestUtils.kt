...
class AwsDynamoDbLocalTestUtils {
    private val BASE_LIBRARY_NAME = "sqlite4java"

    /**
     * Static helper class.
     */
    private fun AwsDynamoDbLocalTestUtils() {}
     ...
     */
    fun initSqLite(libPathSupplier: Supplier<String>) {
    ...
    fun getLibPath(
        ...
        val libNames = getLibNames(os, getArch(os, osArch))
